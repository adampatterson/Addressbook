...
<form method="post" action="<?php echo url::page("update/action_contact/{$contact->id}"); ?>
" enctype="multipart/form-data"  id="addContact">
  <!-- START -->
  <div class="span-21 last content-section">
    <h3 class="left">Update Contact</h3>
    <span class='actionAdd'><a href="<?php echo url::page("admin/delete/{$contact->id}"); ?>
" class="red">Delete</a></span>
    <hr/>
  ...
  <div class="span-21 last content-section">
    <div class="span-10 append-1">
      ...
      foreach ($contacts as $value) {
          ...
          if ($value->type == 'email') { ?>
          <div class="span-10 form-row last">
            <div class="span-2 right small"> <strong>E-Mail</strong> </div>
      ...
      <div class="span-10 form-row last">
        ...
        <div class="span-2 right small"> <strong>E-Mail</strong>
          <!--<br/>
                            <small>
                            Primary Contact
                            </small>-->
        ...
        <div class="span-10 form-row last">
          ...
          <div class="span-7 small-radio">
            <fieldset>
              ...
              <input name="phone[<?=$value->contactid?>][1]" type="radio" value="home" <? if ($value->label == 'home') { echo 'checked="checked"'; }?> />
              <label> Home </label>
              <input name="phone[<?=$value->contactid?>][1]" type="radio" value="work" <? if ($value->label == 'work') { echo 'checked="checked"'; }?> />
              <label> Work </label>
              <input name="phone[<?=$value->contactid?>][1]" type="radio" value="cell" <? if ($value->label == 'cell') { echo 'checked="checked"'; }?> />
              <label> Cell </label>
              <input name="phone[<?=$value->contactid?>][1]" type="radio" value="fax" <? if ($value->label == 'fax') { echo 'checked="checked"'; }?> />
              <label> Fax </label>
              <input name="phone[<?=$value->contactid?>][1]" type="radio" value="other" <? if ($value->label == 'other') { echo 'checked="checked"'; }?> />
              <label> Other </label>
            </fieldset>
          </div>
          <div class="span-1 actions last">
  ...
  <div class="span-21 last content-section">
    ...
    <div class="span-16 prepend-2 data-row last">
      <? 
                        ...
                        ?>
      <div class="span-4 last editDelete"> <a href="<?php echo url::page("admin/update_comment/{$contact->id}/{$comment->commentid}"); ?>"><img src="<?= BASE_URL; ?>assets/images/icons/14-edit.png" width="14" height="14" alt="Edit" />Edit </a> &nbsp;&nbsp;<a href="<?php echo url::page("admin/delete_comment/{$comment->commentid}"); ?>"><img src="<?= BASE_URL; ?>assets/images/icons/14-red-minus-ball.png" width="14" height="14" alt="Delete" /> Delete</a> </div>
    </div>
    <? 
                    }
                    ?>
